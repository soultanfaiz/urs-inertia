...
const statusInfo = computed(() => {
    ...
    // Handle Verification Status changes (Disetujui/Ditolak dari Menunggu)
    if (type === 'verification' && (status === verificationStatus.DISETUJUI || status === verificationStatus.DITOLAK)) {
    ...
    if (type === 'status_change' || (type === 'verification' && status === verificationStatus.MENUNGGU)) {
        switch (status) {
