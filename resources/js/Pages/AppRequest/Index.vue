    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <!-- Daftar Permohonan -->
                <div class="space-y-4">
                    <div v-if="appRequests.data.length > 0">
                        <Link
                            v-for="request in appRequests.data"
                            :key="request.id"
                            :href="route('app-requests.show', request.id)"
                            class="block p-4 bg-white rounded-lg shadow-sm transition duration-150 ease-in-out hover:shadow-md hover:ring-2 hover:ring-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
